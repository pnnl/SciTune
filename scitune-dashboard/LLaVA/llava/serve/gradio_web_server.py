...
SCIENCEQA_QUESTIONS = [
    ...
    "Look at the picture. Which word best describes the sound this thunderstorm makes?\nContext: N/A\nOptions: (A) purring (B) booming (C) squeaking\n<image>", 
...
SCIENCEQA_IMAGEPATH = [ 
                        f"{cur_dir}/examples/sqa1.png", 
                        f"{cur_dir}/examples/sqa2.png", 
                        f"{cur_dir}/examples/sqa3.png", 
                        f"{cur_dir}/examples/sqa5.png", 
                        f"{cur_dir}/examples/sqa6.png", 
                        f"{cur_dir}/examples/sqa7.png", 
                        f"{cur_dir}/examples/sqa8.png", 
                        f"{cur_dir}/examples/sqa9.png", 
                        f"{cur_dir}/examples/sqa10.png", 
                        f"{cur_dir}/examples/sqa11.png", 
                        f"{cur_dir}/examples/sqa12.png",
                        f"{cur_dir}/examples/sqa4.png",
                     ]


gradio_example_list = [list(pair) for pair in zip(SCIENCEQA_IMAGEPATH, SCIENCEQA_QUESTIONS)]
...
def build_demo(embed_mode):
    ...
    with gr.Blocks(title="SteelThread", theme=gr.themes.Default(primary_hue=gr.themes.colors.red, secondary_hue=gr.themes.colors.pink), css=block_css) as demo:
        state = gr.State()
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                #             )
                gr.Examples(examples= gradio_example_list, 
                            inputs=[imagebox, textbox], 
                            examples_per_page=2)
            ...
            with gr.Column(scale=8):
                chatbot = gr.Chatbot(elem_id="chatbot", label="SciTune Chatbot", height=550)
                with gr.Row():
                    with gr.Column(scale=8):
                        textbox.render()
